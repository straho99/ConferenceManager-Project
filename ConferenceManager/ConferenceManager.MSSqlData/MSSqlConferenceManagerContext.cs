namespace ConferenceManager.MSSqlData
{
    ...
    public class MSSqlConferenceManagerContext : DbContext
    {
        public MSSqlConferenceManagerContext()
            : base("name=MSSqlConferenceManagerContext")
        {
        }
